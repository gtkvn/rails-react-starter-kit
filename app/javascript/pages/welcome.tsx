...
export default function Welcome() {
  const { auth, railsVersion, rubyVersion } = usePage<SharedData>().props;

  return (
    <>
      <Head title="Welcome" />
      <div
        className="flex min-h-screen flex-col items-center justify-center bg-[#F0E7E9] bg-cover bg-center text-center leading-tight font-normal text-[#261B23] not-italic"
        style={{
          backgroundImage:
      ...
      >
        ...
        >
          <a
            className="flex rounded-full bg-[#D30001] hover:bg-[#261B23]"
        ...
        <ul className="absolute right-0 bottom-0 left-0 mx-8 mt-0 mb-8 list-none">
          <li>
